...
function M.setup(config)
  ...
  theme.base = {
    ...
    LineNr = { fg = c.fg_sidebar, bg = c.bg_visual }, -- Line number for ":number" and ":#" commands, and when 'number' or 'relativenumber' option is set.
    ...
    Visual = { bg = c.bg_visual, fg = c.fg_sidebar }, -- Visual mode selection
    ...
    String = { fg = c.red1 }, --   a string constant: "this is a string"
    Character = { fg = c.green }, --  a character constant: 'c', '\n'
    -- Number        = { }, --   a number constant: 234, 0xff
    -- Boolean       = { }, --  a boolean constant: TRUE, false
    -- Float         = { }, --    a floating point constant: 2.3e10

    Identifier = { fg = c.yellow, style = config.variableStyle }, -- (preferred) any variable name
